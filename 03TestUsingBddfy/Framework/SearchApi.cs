...
namespace _03TestUsingBddfy.Framework
{
   internal class SearchApi
   {
      ...
      public static HttpResponseMessage SendRequest(IDictionary<string, string> parameter, HttpMethod method)
      {
      ...
      public static string ReadContentAsString(HttpResponseMessage response)
      {
